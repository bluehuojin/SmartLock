...
public class NumView extends View {
    ...
    public NumView(Context context, AttributeSet attrs) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.NumView);

        assert a != null;//Auto Add
        String animType = a.getString(R.styleable.NumView_animate);
        String counter = a.getString(R.styleable.NumView_count);
